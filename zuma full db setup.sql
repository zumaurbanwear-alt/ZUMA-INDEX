...
-- =====================================================================
-- user_roles seed — COMMENTED OUT by default.
-- Reason: this requires an auth.users row with the EXACT SAME UUID
-- (7c54309b-4d59-4494-a5b0-0461d86e42b6) to already exist in this new
-- project, otherwise the INSERT will fail on the foreign key.
--
-- EASIEST PATH: leave this commented, sign up/log in normally on the
-- new site once it's live, then run this manually with YOUR new
-- user's UUID (found in Authentication -> Users):
--
-- INSERT INTO public.user_roles (user_id, role)
-- VALUES ('PASTE-YOUR-NEW-AUTH-USER-UUID-HERE', 'admin');
-- =====================================================================
...
-- 1. Go to Project Settings -> API, copy the "Project URL" and the
--    "anon public" key.
-- 2. In Vercel -> your project -> Settings -> Environment Variables,
--    set/update:
--      VITE_SUPABASE_URL = <Project URL>
--      VITE_SUPABASE_PUBLISHABLE_KEY = <anon public key>
--      VITE_SUPABASE_PROJECT_ID = <the new project ref, e.g. abcdxyz>
-- 3. Redeploy on Vercel.
-- 4. To restore admin access: sign up on the live site with your
--    email, find your new user UUID in Authentication -> Users, then
--    run the commented INSERT above with that UUID.
-- =====================================================================
